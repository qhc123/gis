...
<div class="content">
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
			<form action="__APP__/ConnectUs/update_connect_us" method="post" name="content" id="content">
				<div class="form-group">
				  <label for="connect_person">联系人</label>
				  <input type="text" class="form-control" id="connect_person" name="connect_person" placeholder="请输入联系人" value="<?php echo ($info["connect_person"]); ?>">
				</div>
				<div class="form-group">
				  <label for="connect_phone">联系电话</label>
				  <input type="text" class="form-control" id="connect_phone" name="connect_phone" placeholder="请输入联系电话" value="<?php echo ($info["connect_phone"]); ?>">
				</div>
				<div class="form-group">
				  <label for="connect_fax">传 真</label>
				  <input type="text" class="form-control" id="connect_fax" name="connect_fax" placeholder="请输入传真" value="<?php echo ($info["connect_fax"]); ?>">
				</div>
			    <div class="form-group">
				    <label for="connect_email">E-mail</label>
				    <input type="email" class="form-control" id="connect_email" name="connect_email" placeholder="请输入E-mail" value="<?php echo ($info["connect_email"]); ?>">
			    </div>
			    <div class="form-group">
				    <label for="connect_address">联系地址</label>
				    <input type="text" class="form-control" id="connect_address" name="connect_address" placeholder="请输入联系地址" value="<?php echo ($info["connect_address"]); ?>">
			    </div>
			    <div class="form-group">
			      <label for="connect_qq">咨询QQ</label>
			      <input type="text" class="form-control" id="connect_qq" name="connect_qq" placeholder="请输入联系电话" value="<?php echo ($info["connect_qq"]); ?>">
			    </div>
			    <div class="form-group">
			      <label for="ask_phone">咨询电话</label>
			      <input type="text" class="form-control" id="ask_phone" name="ask_phone" placeholder="请输入联系电话" value="<?php echo ($info["ask_phone"]); ?>">
			    </div>			  
			  <div class="pull-right"><button type="submit" class="btn btn-info" onclick="return checkFrom();">保存修改的内容</button></div>
			</form>
		</div>
	</div>
	<script type="text/javascript">
	...
	function checkFrom(){
		...
		if(add != null){
			...
			if(add.connect_person.value == ''){
				alert('联系人不能为空');
				add.connect_person.focus();
				return false;
			}
			
			if (add.connect_phone.value == '') {
				alert('请填写联系电话');
				add.connect_phone.focus();
				return false;
			}
		    
		    if (add.connect_fax.value == '') {
		    	alert('请输入传真');
		    	add.connect_fax.focus();
		    	return false;
		    }
			
			if(add.connect_address.value == ''){
				alert('联系地址不能为空');
				add.connect_address.focus();
				return false;
			}
